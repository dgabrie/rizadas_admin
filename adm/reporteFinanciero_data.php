<?php
	...
	if ($_SESSION['admin']['id']==4) {
		...
		$result=$conn->ReporteFinanciero($fechaI, $fechaF, $id_doc);
...
<div class="container">
	<div class="row">
			<div class="col-12 card table-responsive">
				...
				<h3>Reporte financiero Citas atendidas entre <?= date("d/m/Y", strtotime($fechaI)) ?> y <?= date("d/m/Y", strtotime($fechaF)) ?></h3>
