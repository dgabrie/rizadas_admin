<?php
	...
	if ($_SESSION['admin']['id']==4) {
		...
		$result=$conn->ReporteCita($fechaI, $fechaF, $id_doc);
...
<div class="container">
	<div class="row">
			<div class="col-12 card table-responsive">
				...
				<h3>Citas atendidas entre <?= date("d/m/Y", strtotime($fechaI)) ?> y <?= date("d/m/Y", strtotime($fechaF)) ?></h3>
                <table class="table" id="listado">
                    ...
                    foreach ($dato as $key => $value) {
                        ...
                        if ($_SESSION['admin']['id']!=4) {
									echo '<td>'.$value['procedimiento'].'</td>';
                        }
