...
if (isset($_SESSION['admin']['usuario'])) {
	...
	<html>
	<head>
		<title>Clinica Dental Gabrie - Admin</title>
			...
			<div class="sticky-header header-section ">
				<div class="header-left">
					...
					<div class="logo">
						<a href="./">
							<ul>	
								<li><img src="img/logo_rosa_sm.png" class="img-logo" style="width:80%; margin-left: 20%; " /></li>
								<li><h1>CD Gabrie</h1></li>
			...
			<div id="page-wrapper">
				...
				<div class="main-page" id="main">
					...
					<div class="d-sm-flex align-items-center justify-content-between mb-4">
						...
						<a href="#" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" href="#" onclick="cargar('AdminCitas','adm/Citas.php','Controller')"><i
							class="fas fa-calendar-plus fa-sm text-white-50"></i> Crear una Cita</a>
						</div>
							...
							<div class="col-md-6 ticket-grid">
								<div class="tickets">
									...
									<div class="grid-right">
										<h3>Citas  <span>Programadas</span></h3>
										<p> Hoy: <span id="Cita_Hoy"></span><br>
											Mañana:<span id="Cita_Mañana"></span></p>
										</div>
										<div class="clearfix"> </div>
									</div>
								</div>
								<div class="col-md-6 ticket-grid">
									<div class="tickets">
										...
										<div class="grid-right">
											<h3>Citas  <span>del Mes</span></h3>
											<p>Reservado: <span id="Citas_Reservadas"></span><br>
												Atendida: <span id="Citas_Atendidas"></span><br>
												Reprogramada: <span id="Citas_Reprogramadas"></span><br>
												No se Presento: <span id="Citas_NSP"></span><br>
											</p>
										</div>
										<div class="clearfix"> </div>
									</div>
								...
								<div class="col-xl-8 col-lg-7 ticket-grid">
									...
									<div class="tickets">
										...
										<h6 class="m-0 font-weight-bold text-primary">Citas del ultimo año</h6>
							...
							if ($_SESSION['admin']['id']!=4) {
								...
								<div class="col-xl-4 col-lg-5 ticket-grid">
									<div class="tickets">
										...
										<div
										class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
										<h6 class="m-0 font-weight-bold text-primary">Resumen Citas Mes</h6>
